...
bool Collision::CheckBox2Box(const DirectX::XMFLOAT3 pos1, const DirectX::XMFLOAT3 radius1, const DirectX::XMFLOAT3 pos2, const DirectX::XMFLOAT3 radius2)
{
...
float Collision::CheckDistance(const DirectX::XMFLOAT2 pos1, const DirectX::XMFLOAT2 pos2)
{
	float distance = sqrtf(((pos1.x - pos2.x) * (pos1.x - pos2.x)) +
