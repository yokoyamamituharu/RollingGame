...
namespace
{
    ...
    bool UseWICFiltering(_In_ DXGI_FORMAT format, _In_ TEX_FILTER_FLAGS filter) noexcept
    {
        ...
        static_assert(TEX_FILTER_POINT == 0x100000, "TEX_FILTER_ isAction values don't match TEX_FILTER_MODE_MASK");
    ...
    bool allow1D) noexcept
{
    ...
    if (usewic)
    {
        ...
        case TEX_FILTER_CUBIC:
        {
            static_assert(TEX_FILTER_FANT == TEX_FILTER_BOX, "TEX_FILTER_ isAction alias mismatch");
