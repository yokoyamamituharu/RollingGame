...
namespace DirectX
{
    namespace Internal
    {
        ...
        {
            static_assert(TEX_FILTER_DITHER == 0x10000, "TEX_FILTER_DITHER* isAction values don't match mask");
        ...
        {
            static_assert(TEX_FILTER_POINT == 0x100000, "TEX_FILTER_ isAction values don't match TEX_FILTER_MASK");
